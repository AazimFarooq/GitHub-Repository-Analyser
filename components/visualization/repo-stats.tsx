...
import { getExtensionColor } from "@/lib/utils/file-utils"
  ...
  return (
    ...
    >
      <motion.div variants={item}>
        <Card className="overflow-hidden card-hover-effect border-none bg-secondary">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="space-y-1 mt-2">
                  {topFileTypes.map(([ext, count], index) => (
